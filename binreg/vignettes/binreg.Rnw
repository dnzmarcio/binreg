...
<<label=fig_aranda_conv,fig=TRUE,height=3,width=3,include=TRUE>>=
...
<<label=fig_aranda,fig=TRUE,height=3,width=3,include=TRUE>>=
...
<<label=fig_prentice_conv,fig=TRUE,height=3,width=3,include=FALSE>>=
#Modelo Prentice:
...
fit <- LaplacesDemon(ModelPrentice(), Data=dados, Initial.Values,
   Covar=fit.burn$Covar, Iterations=500000, Thinning=500,
